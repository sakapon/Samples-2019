...
{
	[TestClass]
	public class FFT102Test
	{
		[TestMethod]
		public void Transform()
		{
			var c1 = new Complex[] { 3, 4, 5, 6, 7 };
			var t = FFT102.Transform(c1, false);
			var c2 = FFT102.Transform(t, true);
			Array.Resize(ref c1, FFT102.ToPowerOf2(c1.Length));
		...
		public void Convolution()
		{
			...
			var actual = FFT102.Convolution(a, b);
